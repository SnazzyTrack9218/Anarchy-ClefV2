...
public class DestroyBlockTask extends Task implements ITaskRequiresGrounded {
    ...
    protected Task onTick(AltoClef mod) {
        ...
        if (reach.isPresent() && (mod.getPlayer().isTouchingWater() || mod.getPlayer().isOnGround()) && !mod.getFoodChain().needsToEat() && !WorldHelper.isInNetherPortal(mod) && mod.getClientPathingBehavior() != null && mod.getClientPathingBehavior().isSafeToCancel()) {
